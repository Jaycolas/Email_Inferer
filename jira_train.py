...
def add_arguments(parser):
    ...
    parser.add_argument("--sequence_length", type=int, default=1000, help="Unified sequence length for each email (default:400)")
    ...
    parser.add_argument("--is_multiclass", type=bool, default=False, help="To indicate if the classification job is multi_class or single class")
